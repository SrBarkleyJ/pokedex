...
const badgesByRegion: { [region: string]: { [badge: string]: string | any } } = {
    ...
    kalos: {
        Iceberg: require('../../src/assets/images/badges/iceberg.png'),
        Lid: require('../../src/assets/images/badges/cliff.png'),
        Muro: require('../../src/assets/images/badges/muro.png'),
        Insecto: require('../../src/assets/images/badges/insecto.png'),
        Voltaje: require('../../src/assets/images/badges/voltaje.png'),
        Hoja: require('../../src/assets/images/badges/hoja.png'),
        Psique: require('../../src/assets/images/badges/psique.png'),
    },
    galar: {
        Leaf: require('../../src/assets/images/badges/leaf.png'),
        Droplet: require('../../src/assets/images/badges/droplet.png'),
        Burn: require('../../src/assets/images/badges/burn.png'),
        Fist: require('../../src/assets/images/badges/fist.png'),
        Phantom: require('../../src/assets/images/badges/phantom.png'),
        Sprite: require('../../src/assets/images/badges/sprite.png'),
        Mountain: require('../../src/assets/images/badges/mountain.png'),
        Shiver: require('../../src/assets/images/badges/shiver.png'),
        Wraith: require('../../src/assets/images/badges/wraith.png'),
    },
    paldea: {
        Bug: require('../../src/assets/images/badges/bug.png'),
        Grass: require('../../src/assets/images/badges/grass.png'),
        Electric: require('../../src/assets/images/badges/dynamo.png'),
        Water: require('../../src/assets/images/badges/casca.png'),
        Normal: require('../../src/assets/images/badges/basic.png'),
        Fantasma: require('../../src/assets/images/badges/fantasma.png'),
        Psiquico: require('../../src/assets/images/badges/psiquico.png'),
        Hielo: require('../../src/assets/images/badges/hielo.png'),
    },
};
