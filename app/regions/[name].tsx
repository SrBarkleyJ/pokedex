...
const regionData: { [key: string]: { name: string; badges: string[]; bulbapedia: string } } = {
    ...
    alola: {
        name: 'Alola',
        badges: ['No Gyms - Island Challenge'],
        bulbapedia: 'https://bulbapedia.bulbagarden.net/wiki/Badge#Alola_League',
    },
    galar: {
        name: 'Galar',
...
const badgesByRegion: { [region: string]: { [badge: string]: string | any } } = {
    ...
    johto: {
        ...
        Rising: 'https://images.wikidexcdn.net/mwuploads/wikidex/d/d1/Medalla_Drag%C3%B3n_Johto.png',
    },
    hoenn: {
    ...
    kalos: {
        Iceberg: 'https://images.wikidexcdn.net/mwuploads/wikidex/8/80/Medalla_Jet.png',
        Lid: 'https://images.wikidexcdn.net/mwuploads/wikidex/8/80/Medalla_Jet.png',
        Muro:   'https://images.wikidexcdn.net/mwuploads/wikidex/8/80/Medalla_Jet.png',
        Insecto:    'https://images.wikidexcdn.net/mwuploads/wikidex/8/80/Medalla_Jet.png',
        Voltaje: 'https://images.wikidexcdn.net/mwuploads/wikidex/8/80/Medalla_Jet.png',
        Hoja: 'https://images.wikidexcdn.net/mwuploads/wikidex/8/80/Medalla_Jet.png',
        Psique: 'https://images.wikidexcdn.net/mwuploads/wikidex/8/80/Medalla_Jet.png',
    },
    galar: {
        Leaf: 'https://images.wikidexcdn.net/mwuploads/wikidex/8/80/Medalla_Jet.png',
        Droplet: 'https://images.wikidexcdn.net/mwuploads/wikidex/8/80/Medalla_Jet.png',
        Burn: 'https://images.wikidexcdn.net/mwuploads/wikidex/8/80/Medalla_Jet.png',
        Fist: 'https://images.wikidexcdn.net/mwuploads/wikidex/8/80/Medalla_Jet.png',
        Phantom: 'https://images.wikidexcdn.net/mwuploads/wikidex/8/80/Medalla_Jet.png',
        Sprite: 'https://images.wikidexcdn.net/mwuploads/wikidex/8/80/Medalla_Jet.png',
        Mountain: 'https://images.wikidexcdn.net/mwuploads/wikidex/8/80/Medalla_Jet.png',
        Shiver: 'https://images.wikidexcdn.net/mwuploads/wikidex/8/80/Medalla_Jet.png',
        Wraith: 'https://images.wikidexcdn.net/mwuploads/wikidex/8/80/Medalla_Jet.png',
    },
    paldea: {
        Insecto: 'https://images.wikidexcdn.net/mwuploads/wikidex/8/80/Medalla_Jet.png',
        Grass: 'https://images.wikidexcdn.net/mwuploads/wikidex/8/80/Medalla_Jet.png',
        Electric: 'https://images.wikidexcdn.net/mwuploads/wikidex/8/80/Medalla_Jet.png',
        Water: 'https://images.wikidexcdn.net/mwuploads/wikidex/8/80/Medalla_Jet.png',
        Normal: 'https://images.wikidexcdn.net/mwuploads/wikidex/8/80/Medalla_Jet.png',
        Fantasma: 'https://images.wikidexcdn.net/mwuploads/wikidex/8/80/Medalla_Jet.png',
        Psiquico: 'https://images.wikidexcdn.net/mwuploads/wikidex/8/80/Medalla_Jet.png',
        Hielo: 'https://images.wikidexcdn.net/mwuploads/wikidex/8/80/Medalla_Jet.png',
    },
};
